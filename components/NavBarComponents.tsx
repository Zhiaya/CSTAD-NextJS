  ...
  return (
    <Navbar className='bg-blue-800'>
      ...
      <NavbarLink className='text-white' href="/" >
        ...
        <NavbarLink className='text-white' href="/job-opportunity">Job Opportunity</NavbarLink>
        <NavbarLink className='text-white' href="/about">About</NavbarLink>
      </NavbarCollapse>
    </Navbar>
  );
}
